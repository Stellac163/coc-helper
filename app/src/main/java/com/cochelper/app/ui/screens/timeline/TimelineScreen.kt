...
fun TimelineScreen(moduleId: Long, navController: NavHostController) {
    ...
    val nodes by container.timelineDao.observeForModule(moduleId).collectAsStateWithLifecycle(emptyList())
    ...
    Scaffold(
        ...
        topBar = {
            SectionTopBar(
                title = "时间轴与大纲",
                leftIcon = Icons.Filled.ReceiptLong,
