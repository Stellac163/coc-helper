...
private fun SavedState?.string(key: String): String? {
    ...
    this?.read { result = getStringOrNull(key) }
    return result
}

private fun SavedState?.long(key: String): Long? {
    var result: Long? = null
    this?.read { result = getLongOrNull(key) }
    return result
}

private fun SavedState?.boolean(key: String): Boolean? {
    var result: Boolean? = null
    this?.read { result = getBooleanOrNull(key) }
    return result
}
...
fun AppNavHost(
    ...
    NavHost(
        ...
        composable(
            ...
            enterTransition = {
                val fade = initialState.arguments.string("trans") == "fade"
                if (fade) fadeEnter else slideEnter
            },
            exitTransition = { if (targetState.arguments.string("trans") == "fade") fadeExit else slideExit },
            popEnterTransition = {
                val fade = initialState.arguments.string("trans") == "fade"
                if (fade) fadeEnter else slidePopEnter
            },
            popExitTransition = { if (targetState.arguments.string("trans") == "fade") fadeExit else slidePopExit },
        ) {
            val id = it.arguments.long("moduleId") ?: 0L
        ...
        composable(
            ...
            OriginalDocScreen(it.arguments.long("moduleId") ?: 0L, navController)
        }
        ...
        composable(
            ...
            CompanionFilesScreen(it.arguments.long("moduleId") ?: 0L, navController)
        }
        ...
        composable(
            ...
            IntroEditorScreen(it.arguments.long("moduleId") ?: 0L, navController)
        }
        ...
        composable(
            ...
            TimelineScreen(it.arguments.long("moduleId") ?: 0L, navController)
        }
        ...
        composable(
            ...
            LocationsScreen(it.arguments.long("moduleId") ?: 0L, navController)
        }
        ...
        composable(
            ...
            LocationDetailScreen(it.arguments.long("locationId") ?: 0L, navController)
        }
        ...
        composable(
            ...
            NpcListScreen(it.arguments.long("moduleId") ?: 0L, navController)
        }
        ...
        composable(
            ...
            PcListScreen(it.arguments.long("moduleId") ?: 0L, navController)
        }
        ...
        composable(
            ...
            PcDetailScreen(
                pcId = it.arguments.long("pcId") ?: 0L,
                showAvatar = it.arguments.boolean("avatar") ?: false,
                navController = navController,
            )
        }
        ...
        composable(
            ...
            NpcDetailScreen(it.arguments.long("npcId") ?: 0L, navController)
        }
