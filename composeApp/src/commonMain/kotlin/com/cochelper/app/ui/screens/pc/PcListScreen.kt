...
fun PcListScreen(moduleId: Long, navController: NavHostController) {
    ...
    val pcs by container.pcDao.observeForModule(moduleId).collectAsState(emptyList())
    ...
    Scaffold(
        ...
        if (pcs.isEmpty()) {
            ...
            Column(
                ...
                pcs.forEach { pc ->
                    PcListCard(pc = pc, onClick = { navController.navigate(Routes.pc(pc.id, avatar = false)) })
                }
            }
        }
    }
